...
ap.mapgen.crust:register("heightmap.init", function(constructor)
...
ap.mapgen.crust:register("heightmap.major", function(constructor)
...
ap.mapgen.crust:register("heightmap.minor", function(constructor)
...
ap.mapgen.crust:register("heightmap.canyon", function(constructor)
...
ap.mapgen.crust:register("heightmap.ravine", function(constructor)
	constructor:add_param("fade", 0.1)
...
ap.mapgen.crust:register("heightmap.channels", function(constructor)
	constructor:add_param("fade", 0.1)
...
ap.mapgen.crust:register("heightmap.cliffs", function(constructor)
...
ap.mapgen.crust:register("heightmap.extrusions", function(constructor)
...
ap.mapgen.crust:register("heightmap.positive-highlights", function(constructor)
	constructor:add_param("smoothed", true)
	constructor:add_param("threshold_mask_max", 1.0)
...
ap.mapgen.crust:register("heightmap.negative-highlights", function(constructor)
	constructor:add_param("smoothed", true)
...
ap.mapgen.crust:register("heightmap.peaks", function(constructor)
...
ap.mapgen.crust:register("heightmap.trenches", function(constructor)
	constructor:add_param("multiplier", -6)
...
ap.mapgen.crust:register("heightmap.flatlands", function(constructor)
...
ap.mapgen.crust:register("heightmap.terraces", function(constructor)
	constructor:add_param("fade", 0.1)
...
ap.mapgen.crust:register("heightmap.round", function(constructor)
	constructor:set_condition(worldgenfunctions.if_true("generate_heightmap"))
	constructor:set_run_2d(function(module, metadata, manipulator, x, z)
...
ap.mapgen.crust:register("heightmap.finalization", function(constructor)
	constructor:set_condition(worldgenfunctions.if_true("generate_heightmap"))
	constructor:set_run_2d(function(module, metadata, manipulator, x, z)
